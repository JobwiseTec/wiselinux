...
_build-bib $target_image $tag $type $config: (_rootful_load_image target_image tag)
    ...
    # --rootfs só para imagens de disco (qcow2/raw): diz ao BIB qual FS criar.
    # No ISO, o particionamento vem do kickstart (iso.toml); passar --rootfs faz
    # o BIB gerar o layout dele e sobrepor o kickstart (era a causa do root+home).
    [ "${type}" = "iso" ] || args+="--rootfs=btrfs"
